...
class SlowEthBuyer(DrawableStrategy):
    daily_budget: float
    comission: float

    def __init__(self):
        self.strategy_name = Strategies.slow_eth_buyer
    ...
    def _step(self, atoms: List[Atom], index: int):
        ...
        strategy.crypto_count = self.daily_budget / atoms[index].quotation[Tickers.eth_ticker] * (1 - self.comission)
    ...
    def _draw(self, **kwargs):
        ...
        fig.write_html(GRAPHS_FOLDER + 'slow_buyer_eth.html', auto_open=True)
